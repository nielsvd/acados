...
CASADI_SYMBOL_EXPORT int pathcon_nm2(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int pathcon_nm2_n_in(void) { return 3;}
