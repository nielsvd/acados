...
/* vde_adj_chain_nm7:(i0[36],i1[36],i2[3],i3[39])->(o0[39]) */
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm7(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm7_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT int vde_adj_chain_nm7_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* vde_adj_chain_nm7_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* vde_adj_chain_nm7_name_out(int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const int* vde_adj_chain_nm7_sparsity_in(int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const int* vde_adj_chain_nm7_sparsity_out(int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm7_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 29;
