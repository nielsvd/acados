...
static const int casadi_s3[9] = {0, 6, 0, 0, 0, 0, 0, 0, 0};

/* pathconN_nm2:(i0[6],i1[3],i2[6])->(o0[0],o1[0x6]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT int pathconN_nm2(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int pathconN_nm2_n_in(void) { return 3;}
