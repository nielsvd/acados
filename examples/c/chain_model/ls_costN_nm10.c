...
CASADI_SYMBOL_EXPORT int ls_costN_nm10(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int ls_costN_nm10_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT int ls_costN_nm10_n_out(void) { return 2;}

CASADI_SYMBOL_EXPORT const char* ls_costN_nm10_name_in(int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* ls_costN_nm10_name_out(int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const int* ls_costN_nm10_sparsity_in(int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const int* ls_costN_nm10_sparsity_out(int i) {
  switch (i) {
    case 0: return casadi_s0;
...
CASADI_SYMBOL_EXPORT int ls_costN_nm10_work(int *sz_arg, int* sz_res, int *sz_iw, int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 2;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 2;
