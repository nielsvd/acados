...
/* vde_chain_nm3:(i0[12],i1[12x12],i2[12x3],i3[3],i4[15])->(o0[12],o1[12x12],o2[12x3]) */
...
CASADI_SYMBOL_EXPORT int vde_chain_nm3(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int vde_chain_nm3_n_in(void) { return 5;}
