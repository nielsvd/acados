...
/* vde_adj_chain_nm5:(i0[24],i1[24],i2[3],i3[27])->(o0[27]) */
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm5(const casadi_real** arg, casadi_real** res, int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm5_n_in(void) { return 4;}
